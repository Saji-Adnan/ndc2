        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" method="post" enctype="multipart/form-data" action="{{route('news.store')}}">
                        @csrf
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="title" id="title"  class="form-control {{$errors->has('title')?'is-invalid':''}}" value="{{old('title')}}"  placeholder="Enter The Title..">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control {{$errors->has('category_id')?'is-invalid':''}}" id="exampleFormControlSelect1" name="category_id" id="category_id"  >
                                                ...
                                                <option {{old('category_id')?"selected":""}} value="{{$row->id}}">{{$row->title}}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="summary" id="summary" class="form-control {{$errors->has('summary')?'is-invalid':''}}" value="{{old('summary')}}" placeholder="Enter The Sammary...">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control {{$errors->has('detalis')?'is-invalid':''}}" id="exampleFormControlTextarea1" name="detalis" rows="3" placeholder="Enter The Details..." >{{old('detalis')}}</textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="kt-checkbox-inline">
                                                <label class="kt-checkbox">
                                                    <input type="checkbox"  value="1" id="published" name="published" {{old('published')?"checked":""}} > Published
